      ...
      {!loading &&
        launches.map((item, index) => (
          <div key={index} className="px-2 pb-4 flex-grow w-full ">
            <div className="bg-white p-6 h-full min-w-full border border-gray-300 flex flex-col justify-between rounded-md shadow">
              <div className="bg-whitesmoke">
                {item.links.mission_patch_small ? (
                  ...
                  <div className="mb-4 mt-auto flex bg-gray-300  justify-center">
